...
export default function AcompanhamentoObraScreen() {
  ...
  const OBRA_ID = "b2c3d4e5-0000-0000-0000-000000000002";
...
const styles = StyleSheet.create({
  ...
  progressBarFill: {
    height: "100%",
    background: "linearGradient(90deg, #81EF99 0%, #46DFB3 26.92%, #09D1C7 51.44%, #16929C 75.96%, #0D6579 100%)",
    borderRadius: 4,
  },
  cicloRow: {
    flexDirection: "row",
